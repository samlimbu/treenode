 ...
 export let htmlData: Object[] =  [
    ...
    },
    {
        ...
        subtasks: [
            {
                taskID: 13,
                taskName: 'Phase Implementation 1',
                startDate: new Date('02/17/2017'),
                endDate: new Date('02/27/2017'),
                priority: 'High',
                approved: false,
            ...
            {
                taskID: 21,
                taskName: 'Phase Implementation 2',
                startDate: new Date('02/17/2017'),
            ...
            {
                taskID: 29,
                taskName: 'Phase Implementation 3',
                startDate: new Date('02/17/2017'),
                endDate: new Date('02/27/2017'),
                priority: 'Normal',
                approved: false,
...
export let sampleData: Object[] =  [
    ...
    },
    {
        ...
        subtasks: [
            {
                taskID: 13,
                taskName: 'Phase 1 Implementation',
                startDate: new Date('02/17/2017'),
                endDate: new Date('02/27/2017'),
                priority: 'High',
                approved: false,
            ...
            {
                taskID: 21,
                taskName: 'Phase 2 Implementation',
                startDate: new Date('02/17/2017'),
                endDate: new Date('02/28/2017'),
                priority: 'High',
                approved: false,
            ...
            {
                taskID: 29,
                taskName: 'Phase 3 Implementation',
                startDate: new Date('02/17/2017'),
                endDate: new Date('02/27/2017'),
                priority: 'Normal',
                approved: false,
